defmodule RealDealApi.UsersTest do
  ...
  describe "users" do
    ...
    @invalid_attrs %{name: nil, gender: nil, biography: nil}
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{name: "some name", gender: "some gender", biography: "some biography"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{name: "some updated name", gender: "some updated gender", biography: "some updated biography"}
